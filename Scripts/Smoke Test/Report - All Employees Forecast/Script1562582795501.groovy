...
WebUI.click(findTestObject('Smoke Test/Reports/Link/Reports - All Employees Forecast'))

WebUI.delay(5)

WindowTitle = WebUI.getWindowTitle()

WebUI.verifyMatch(WindowTitle, 'All Employees Forecast | ERNI Connect', false)
