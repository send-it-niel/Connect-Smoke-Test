...
WebUI.click(findTestObject('Smoke Test/People - People Search/Link - Objects/Link - 1st employee on table'))

WebUI.delay(5)

WindowTitle = WebUI.getWindowTitle()

WebUI.verifyMatch(WindowTitle, 'Profile | ERNI Connect', false)
